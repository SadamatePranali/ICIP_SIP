...
public class RawSMTPClient {
    public static void main(String[] args) {
        ...
        final String from = "pranalisadamate@gmail.com";
        final String to = "pranalisadamate634@gmail.com";
        final String username = "pranalisadamate@gmail.com";
        final String password = "Sadamate@7741"; // Use app-specific password if 2FA is enabled
